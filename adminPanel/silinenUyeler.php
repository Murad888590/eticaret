<div class="kargolar">
   <?php
      ...
      $toplamKayitSayisiSorgusu = $db->prepare("SELECT * FROM users WHERE  silinmeDurumu = 1 $searchingUser ORDER BY id DESC");
   ...
   ?>
      ...
      <div class="addBank">
         <a href="index.php?sayfaKoduDis=0&sayfaKoduIc=41">İştifadəçilər</a>
      </div>
      <?php
    ...
    <div class="manWrapper__items__search">
         <div class="row height d-flex justify-content-center align-items-center">
            <form action="index.php?sayfaKoduDis=0&sayfaKoduIc=43" method="post" class="">
      ...
      <?php
         $usersFetch = $db->prepare("SELECT * FROM users WHERE silinmeDurumu = 1 $searchingUser ORDER BY id DESC LIMIT $sayfalamayBaslayacaqKayotSayisi, $sayfaBasinaGosterilecek");
         $usersFetch->execute();
            ...
            foreach($users as $user) {?>
                  <div class="users__item">
                     ...
                     <div class="user__delete">
                        <a href="index.php?sayfaKoduDis=0&sayfaKoduIc=44&id=<?=$user["id"]?>"><img src="../assets/images/HedefMaviOkSiyah20x20.png" alt=""></a>
                     </div>
                  </div>
            <?
            }
      ...
      if($bulunanSafyaSayisi>1) {?>
         <div style="margin: 30px 320px" class="paginationWrapper">
            <nav aria-label="Page navigation example ">
               <ul class="pagination">
               <li class="page-item"><a class="page-link" href="index.php?sayfaKoduDis=0&sayfaKoduIc=43&sayfalama=1<?$sayfalamaKosulu?>">&laquo;</a></li>
               <?php
                  for($i = $sayfalama-$sayfalamaIcinButonSayisi; $i <= $sayfalama+$sayfalamaIcinButonSayisi; $i++) {
                     ...
                     if($sayfalama == $i) {
                        ...
                        echo "<li class=\"page-item\"><a class=\"page-link\" href=\"index.php?sayfaKoduDis=0&sayfaKoduIc=43&sayfalama=$curr\">$curr</a></li>";
                     }
                  }
               }
               ?>
                  
                  <li class="page-item"><a class="page-link"  href="index.php?sayfaKoduDis=0&sayfaKoduIc=43&sayfalama=<?=$bulunanSafyaSayisi?>&<?$sayfalamaKosulu?>">&raquo;</a></li>
               </ul>
            </nav>
         </div>
      <?php
